...
<div id='area'>
    ...
    <form id="form-aluno" name="formulario" method="POST">
        ...
        <h1 id="titulo"> FAÇA LOGIN </h1>
            ...
            <p id="msg"><a href="cadastro.php">Crie uma Conta aqui!</a></p>
    </form>
    ...
    echo "<p>Parabéns! Você logou com sucesso, aproveite seu tempo logado, e caso queira deslogar, basta clicar <a href='logoff.php' >AQUI!</a></p></div>";
}
?>
</body>
</html>